(function () {
    ...
    const controller = function (Base,
        ...
        class PortfolioRow extends Base {
            ...
            $postLink() {
                this._isWaves = this.balance.asset.id === WavesApp.defaultAssets.DCC;
            ...
            _getCanShowDex() {
                ...
                return !isAssetLockedInDex &&
                    (this.balance.isPinned ||
                        ...
                        this.balance.asset.id === WavesApp.defaultAssets.DCC ||
            ...
            _onUpdateBalance() {
                ...
                if (baseAssetId === balance.asset.id) {
                    ...
                    const baseChange24AssetId = WavesApp.defaultAssets.DCC === balance.asset.id ?
                        baseAssetId :
                ...
                if (baseAssetId === balance.asset.id) {
                    ...
                    if (hasRate && !this.isGateway && balance.asset.id !== WavesApp.defaultAssets.DCC) {
